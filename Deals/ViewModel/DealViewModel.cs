...
namespace Deals.ViewModel
{
    public class DealViewModel : ViewModelBase
    {
        ...
        private readonly ObservableCollection<Deal> _refDeals = new ObservableCollection<Deal>(){
            ...
            new Deal { mPhotoID = 1003, mCaption = "Adidas Dragon (S81908)", mDesc = "NEW ADIDAS DRAGON (S81908) All Sz ORIGINALS CASUAL SHOES SNEAKERS", mPercentage = 10, mImageUrl = "ggg",mTags="shoe",mFav=false },
            new Deal { mPhotoID = 1004, mCaption = "adidas Jogger", mDesc = "gym shoe new dragon sl 72", mPercentage = 40, mImageUrl = "fff",mTags="shoe",mFav=true },
            new Deal { mPhotoID = 1005, mCaption = "Columbia River Knife", mDesc = "Columbia River Knife and Tool's Eat N Tool 9100C Silver Multi Too", mPercentage = 30, mImageUrl = "ddd",mTags="knife",mFav=false },
            new Deal { mPhotoID = 1007, mCaption = "Watershed Chattooga Dry", mDesc = "Watershed Chattooga Dry Duffel 3 Colors Outdoor Duffel", mPercentage = 10, mImageUrl = "bbb",mTags="bag",mFav=false }
